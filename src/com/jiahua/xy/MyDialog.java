...
public class MyDialog extends JDialog
{
    ...
    private void onOK()
    {
        ...
        if (null != mCallBack)
        {
            mCallBack.ok(textField1.getText().trim(), textField2.getText().trim(), textField3.getText().trim(), textField4.getText().trim(), actiRadioButton.isSelected());
        }
        dispose();
    }
...
//    }
    ...
    {
        void ok(String author, String moduleName, String appName, String packageName, boolean isAc);
    }
